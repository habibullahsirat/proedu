...
export default function SiteList({ site, onEdit, onDelete, isDeleting }) {
    ...
    return (
      <div className="text-center py-12 bg-gray-50 rounded-lg">
        <p className="text-gray-500 text-lg">
          No site data found. Add your first site data!
        </p>
      </div>
    );
  }
      ...
      {site.map((site) => (
        ...
        >
          ...
          <div className="relative h-48 w-full bg-gray-100">
            ...
            {site.image1?.includes("cloudinary") && (
