...
export default function PartnerList({ partner, onEdit, onDelete, isDeleting }) {
      ...
      {partner.map((partner) => (
        ...
        >
          ...
          <div className="relative h-48 w-full bg-gray-100">
            ...
            {partner.image?.includes("cloudinary") && (
          ...
          <div className="p-4">
            ...
            <div className="flex items-center justify-between text-xs text-gray-400 mb-4">
              <span>ID: {partner._id.slice(-6)}</span>
              <span>
